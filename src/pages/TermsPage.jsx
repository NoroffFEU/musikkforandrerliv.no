...
function TermsPage() {
  return (
    <ErrorBoundary>
      <section className="terms-page min-h-screen container mt-50 mx-auto px-8 text-center">
        <div className="flex flex-col items-center text-center mb-16">
          ...
          <p className="pt-4 pb-4 text-lg">
            ...
            totam sit laudantium quisquam incidunt hic veniam ad maiores
            possimus iure voluptatibus voluptate pariatur cupiditate vero itaque
            non, accusantium eaque porro.
          </p>
        </div>
