...
export default function HeroBanner() {
  ...
  return (
    ...
    >
      <h1
        className="text-5xl md:text-7xl font-medium [font-family:var(--font-justAnotherHand)] text-white absolute inset-0 flex items-center justify-center uppercase tracking-wider mt-25 sm:mt-52"
      ...
      />
      <nav
      className={`workNavWrapper text-white flex flex-row flex-wrap gap-[10px] xl:gap-[30px] absolute ${bottomPosition} sm:bottom-10 items-center justify-center`}
