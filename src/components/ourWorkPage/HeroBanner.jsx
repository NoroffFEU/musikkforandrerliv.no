export default function HeroBanner() {
  return (
    <section className="relative flex flex-col items-center">
      ...
      />
      <nav className="workNavWrapper text-white flex flex-row flex-wrap gap-[10px] absolute bottom-10 items-center justify-center">
        <div className="workNavButton flex flex-col items-center justify-between lg:justify-center lg:gap-[10%] p-2 text-center bg-[#5b8e7d] rounded-lg w-[85px] h-[85px] lg:w-[150px] lg:h-[150px]">
          <img
