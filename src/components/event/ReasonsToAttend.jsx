...
const ReasonsToAttend = () => {
  return (
    <div className="w-full max-w-[1000px] mx-auto px-4 pb-[60px] font-montserrat text-[#212121]">
      <h2 className="font-semibold text-[32px] mt-16 mb-4 leading-[150%]">
        Why Attend?
      </h2>
      <p className="text-[18px] mb-8 leading-[160%]">
      ...
      <h2 className="font-semibold text-[32px] mb-4 leading-[150%]">
        What to Expect?
      </h2>
      <ul className="list-disc pl-5 text-[18px] space-y-3 mb-8">
        <li>
      ...
      <ul className="list-disc pl-5 text-[18px] space-y-3 mb-6">
      ...
      <p className="text-[18px] mb-4 leading-[160%]">
      ...
      <p className="text-[18px] mt-6 leading-[160%]">
