  ...
  return (
    <div className="w-full max-w-[1000px] mx-auto mt-[100px] pb-[60px] px-4 font-montserrat">
      ...
      <p className="text-[18px] pb-[24px] leading-[150%]">
        ...
        2024, as we host our annual Back-to-School Fundraiser Gala at the
        prestigious Le Jardin Étoilé, Route Royale, Antananarivo, Madagascar.
        This gala isn't just an event; it's a celebration of hope, a testament
        to the power of education, and a night that promises to make a
        significant difference in the lives of children in Madagascar.
      </p>
    </div>
  );
};
