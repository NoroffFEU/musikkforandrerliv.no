...
const AboutUsSection = () => {
  ...
  const introImageAlt =
    aboutUsPageContent.sections[0]?.imageAlt || 'About section image';

  // Get middle sections from CMS
  const cmsSections = ready ? t('about.sections', { returnObjects: true }) : [];
  ...
  const middleSections =
    Array.isArray(cmsSections) && cmsSections.length > 0
      ? cmsSections
      : fallbackSections;
