...
function Navbar() {
  ...
  const getDesktopLinkClasses = ({ isActive }) =>
    isActive
      ? "flex items-center text-[var(--color-alt-forest-green)] font-montserrat text-[14px] uppercase font-semibold"
      : "flex items-center text-[#000000] hover:text-[var(--color-alt-forest-green)] font-montserrat text-[14px] uppercase font-semibold";

  const getMobileLinkClasses = ({ isActive }) =>
    isActive
      ? "block py-2 font-montserrat text-[var(--color-alt-forest-green)] text-[14px] uppercase font-semibold"
      : "block py-2 font-montserrat text-[#000000] hover:text-[var(--color-alt-forest-green)] text-[14px] uppercase font-semibold";
  ...
  return (
    <>
            ...
            <div className="hidden md:flex items-center space-x-6">
              ...
              <div className="relative" ref={searchRef}>
                <button
                  ...
                  className="search-toggle flex items-center text-[#000000] hover:text-[var(--color-alt-forest-green)] font-montserrat text-[14px] uppercase font-semibold"
                >
                  <svg
              ...
              <div className="relative" ref={dropdownRef}>
                <button
                  ...
                  className="dropdown-toggle inline-flex items-center text-[#000000] hover:text-[var(--color-alt-forest-green)] font-montserrat text-[14px] uppercase font-semibold"
                >
                  More
                  <svg
      ...
      {isMenuOpen && (
        <div className="fixed top-16 left-0 w-full bg-white z-40 md:hidden overflow-y-auto border-t shadow-md">
          <div className="px-4 pt-4 pb-8 space-y-5">
            <div className="space-y-2">
              <button
                onClick={toggleSearch}
                className="flex items-center text-[#000000] hover:text-[var(--color-alt-forest-green)] font-montserrat text-[14px] uppercase font-semibold"
              >
                <svg
                  className="mr-1 h-5 w-5"
                  fill="none"
