    ...
    <div>
      <div className="flex flex-col gap-[25px] justify-center items-center md:items-stretch container md:flex-row md:gap-[52px] transition-all duration-300 ease-in-out">
        <fieldset  
          ...
          <h2 id='plan-label' className="font-sans text-[18px] md:text-[20px] md:text-left sm:text-center text-[#363732] font-semibold mb-[44px]">
            Choose a plan
          </h2>
          <RadioInput
            name="plan"
        ...
        <fieldset  
          ...
          <h2 id='payment-label' className="font-sans text-[18px] md:text-[20px] md:text-left sm:text-center text-[#363732] font-semibold mb-[44px]">
