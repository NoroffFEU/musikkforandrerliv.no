...
const openSearchDrawerBtn = document.querySelector(
    'button#openSearchBarDrawer'
);
...
function closeSearch() {
    ...
    if (searchResultsContainer)
        searchResultsContainer.setAttribute('hidden', 'true'); // !Placeholder container for search results - delete me - here and in index.html
    searchInput.value = '';
